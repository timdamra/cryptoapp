...
const Footer = props => {
  return (
    <FooterDiv>
      <FooterSection>
        <FooterSubSection>
          <i style={{ padding: '10px' }} className="fab fa-facebook-f fa-3x" />
          <i style={{ padding: '10px' }} className="fab fa-twitter fa-3x" />
          <i style={{ padding: '10px' }} className="fab fa-youtube fa-3x" />
        </FooterSubSection>
      </FooterSection>
      <FooterSection>
